...
Let $Y_1, \ldots, Y_n$ be independent and identically distributed random variables with distribution $F$ and finite variance and let $\overline{Y}_n = \sum_{i=1}^n Y_i$ denote the sample mean.
...
\begin{align*}
\frac{\overline{Y}_n - \mu_0}{S_n} \stackrel{\cdot}{\sim} \mathsf{St}_{n-1},
\end{align*}
